...
/** Cette classe gère tout le jeu, elle met en relation les éléments du jeu, les menus, l'affichage...
 * C'est cette classe qu'il faut compiler et exécuter pour lancer le jeu.
 * @author Alexis Carn
 */
