...
public class PetrinetFactoryImpl extends EFactoryImpl implements PetrinetFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case PetrinetPackage.EDGE: return createEdge();
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case PetrinetPackage.ARC_TYPE:
				return createarc_typeFromString(eDataType, initialValue);
			default:
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
			case PetrinetPackage.ARC_TYPE:
				return convertarc_typeToString(eDataType, instanceValue);
			default:
				throw new IllegalArgumentException("The datatype '" + eDataType.getName() + "' is not a valid classifier");
		}
	}
	 ...
	 * @generated
	 */
	public arc_type createarc_typeFromString(EDataType eDataType, String initialValue) {
		arc_type result = arc_type.get(initialValue);
	 ...
	 * @generated
	 */
	public String convertarc_typeToString(EDataType eDataType, Object instanceValue) {
